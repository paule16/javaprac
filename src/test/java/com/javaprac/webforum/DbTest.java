...
public class DbTest {
    ...
    public void testSectionGetActiveUsers()
    {
        ...
        assert(first_result.get(0).msgNum == 2);
        assert(first_result.get(0).minCreationTime.equals(cutNanos(msg_1.getCreationTime())));
        assert(first_result.get(0).maxCreationTime.equals(cutNanos(msg_2.getCreationTime())));

        assert(second_result.size() == 2);
        assert(second_result.get(1).user.equals(user_2));
        assert(second_result.get(1).msgNum == 1);
        assert(second_result.get(1).minCreationTime.equals(cutNanos(msg_3.getCreationTime())));
        assert(second_result.get(1).maxCreationTime.equals(cutNanos(msg_3.getCreationTime())));
        assert(second_result.get(0).user.equals(user_1));
        assert(second_result.get(0).msgNum == 1);
        assert(second_result.get(0).minCreationTime.equals(cutNanos(msg_4.getCreationTime())));
        assert(second_result.get(0).maxCreationTime.equals(cutNanos(msg_4.getCreationTime())));

        assert(third_result.size() == 2);
        assert(third_result.get(0).user.equals(user_1));
        assert(third_result.get(0).msgNum == 3);
        assert(third_result.get(0).minCreationTime.equals(cutNanos(msg_1.getCreationTime())));
        assert(third_result.get(0).maxCreationTime.equals(cutNanos(msg_4.getCreationTime())));
        assert(third_result.get(1).user.equals(user_2));
        assert(third_result.get(1).msgNum == 1);
        assert(third_result.get(1).minCreationTime.equals(cutNanos(msg_3.getCreationTime())));
        assert(third_result.get(1).maxCreationTime.equals(cutNanos(msg_3.getCreationTime())));
