...
public class CheckGlobalSearch {
  ...
  @Test
  public void testCheckGlobalSearch() throws Exception {
    ...
    driver.findElement(By.id("section_name")).sendKeys("Public read section");
    ...
    driver.findElement(By.id("section_name")).click();
    driver.findElement(By.id("section_name")).clear();
    driver.findElement(By.id("section_name")).sendKeys("Public read discussion");
    ...
    driver.findElement(By.id("new_msg_input")).sendKeys("accessible message (public section / public discussion)");
    driver.findElement(By.id("msg_create_button")).click();
    driver.findElement(By.id("bar_section")).click();
    driver.findElement(By.id("create_discussion_button")).click();
    driver.findElement(By.id("section_name")).click();
    driver.findElement(By.id("section_name")).clear();
    driver.findElement(By.id("section_name")).sendKeys("Discussion with a common name");
    driver.findElement(By.id("create_button")).click();
    driver.findElement(By.id("new_msg_input")).click();
    driver.findElement(By.id("new_msg_input")).clear();
    driver.findElement(By.id("new_msg_input")).sendKeys("accessible message (public section / common discussion)");
    driver.findElement(By.id("msg_create_button")).click();
    driver.findElement(By.xpath("//a[@id='bar_section']/h5")).click();
    driver.findElement(By.id("create_discussion_button")).click();
    driver.findElement(By.id("section_name")).click();
    driver.findElement(By.id("section_name")).clear();
    driver.findElement(By.id("section_name")).sendKeys("Role discussion");
    ...
    driver.findElement(By.id("new_msg_input")).click();
    driver.findElement(By.id("new_msg_input")).clear();
    driver.findElement(By.id("new_msg_input")).sendKeys("accessible message (public section / private discussion)");
    driver.findElement(By.id("msg_create_button")).click();
    driver.findElement(By.id("bar_section")).click();
    driver.findElement(By.id("create_discussion_button")).click();
    driver.findElement(By.id("section_name")).click();
    driver.findElement(By.id("section_name")).clear();
    driver.findElement(By.id("section_name")).sendKeys("Discussion of another role");
    driver.findElement(By.id("add_button")).click();
    driver.findElement(By.id("perm_tbl_row_role_0")).click();
    driver.findElement(By.id("perm_tbl_row_role_0")).clear();
    ...
    driver.findElement(By.id("new_msg_input")).click();
    driver.findElement(By.id("new_msg_input")).clear();
    driver.findElement(By.id("new_msg_input")).sendKeys("inaccessible message (public section / private discussion)");
    driver.findElement(By.id("msg_create_button")).click();
    driver.findElement(By.xpath("//a[@id='bar_main_title']/h3")).click();
    driver.findElement(By.linkText("+ создать раздел")).click();
    driver.findElement(By.id("section_name")).click();
    driver.findElement(By.id("section_name")).clear();
    driver.findElement(By.id("section_name")).sendKeys("Role section");
    driver.findElement(By.id("perm_tbl_add_button")).click();
    driver.findElement(By.id("perm_tbl_role_0")).click();
    driver.findElement(By.id("perm_tbl_role_0")).clear();
    ...
    driver.findElement(By.id("new_msg_input")).click();
    driver.findElement(By.id("new_msg_input")).clear();
    driver.findElement(By.id("new_msg_input")).sendKeys("accessible message (private section)");
    driver.findElement(By.id("msg_create_button")).click();
    driver.findElement(By.xpath("//a[@id='bar_main_title']/h3")).click();
    driver.findElement(By.linkText("+ создать раздел")).click();
    driver.findElement(By.id("section_name")).click();
    driver.findElement(By.id("section_name")).clear();
    driver.findElement(By.id("section_name")).sendKeys("Section of another role");
    driver.findElement(By.id("perm_tbl_add_button")).click();
    driver.findElement(By.id("perm_tbl_role_0")).click();
    driver.findElement(By.id("perm_tbl_role_0")).clear();
    ...
    driver.findElement(By.id("section_name")).click();
    driver.findElement(By.id("section_name")).clear();
    driver.findElement(By.id("section_name")).sendKeys("Discussion in a private section");
    driver.findElement(By.id("create_button")).click();
    driver.findElement(By.id("new_msg_input")).click();
    driver.findElement(By.id("new_msg_input")).clear();
    driver.findElement(By.id("new_msg_input")).sendKeys("inaccessible message (private section)");
    driver.findElement(By.id("msg_create_button")).click();
    driver.findElement(By.xpath("//a[@id='bar_main_title']/h3")).click();
    ...
    assertEquals(driver.findElement(By.xpath("//*/text()[normalize-space(.)='accessible message (private section)']/parent::*")).getText(), "accessible message (private section)");
    assertEquals(driver.findElement(By.xpath("//*/text()[normalize-space(.)='accessible message (public section / public discussion)']/parent::*")).getText(), "accessible message (public section / public discussion)");
    assertEquals(driver.findElement(By.xpath("//*/text()[normalize-space(.)='accessible message (public section / common discussion)']/parent::*")).getText(), "accessible message (public section / common discussion)");
    assertEquals(driver.findElement(By.xpath("//*/text()[normalize-space(.)='accessible message (public section / private discussion)']/parent::*")).getText(), "accessible message (public section / private discussion)");
    driver.findElement(By.id("bar_search")).click();
    driver.findElement(By.id("bar_search")).clear();
    driver.findElement(By.id("bar_search")).sendKeys("inaccessible");
    driver.findElement(By.id("bar_search_button")).click();
    assertEquals(driver.findElement(By.xpath("//*/text()[normalize-space(.)='inaccessible message (private section)']/parent::*")).getText(), "inaccessible message (private section)");
    assertEquals(driver.findElement(By.xpath("//*/text()[normalize-space(.)='inaccessible message (public section / private discussion)']/parent::*")).getText(), "inaccessible message (public section / private discussion)");
    driver.findElement(By.id("bar_auth_button")).click();
