...
INSERT INTO Discussions (label, description, creator_id, creation_time, permissions, section_id)
VALUES
...
INSERT INTO Messages (creator_id, content, attachments, creation_time, discussion_id, quote_msg_id, quote_start, quote_end)
VALUES
